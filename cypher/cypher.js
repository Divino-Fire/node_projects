...
export function cypher(text, shift){ // shift is a number between 0 and 26 and text is the text you wish to decipher.
...
export function log(variable, value){ // function to be used for debugging purposes only
